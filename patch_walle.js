const fs = require('fs');
const path = 'a:/HADJAL/Рабочий стол/asgard-redesign/components/eternity-landing.tsx';

let content = fs.readFileSync(path, 'utf8');

// Найти блок от WalleOnGlobe до const WALLE_CSS (включительно до конца WALLE_CSS строки)
const startMarker = '// ─── ВАЛЛИ на глобусе ────────────────────────────────────────────────────────';
const endMarker = 'const CSS = `';
...
const newBlock = `// ─── ВАЛЛИ минималистичный ──────────────────────────────────────────────────
