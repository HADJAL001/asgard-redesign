...
Обновлено: 2026-08-25 05:23 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 99.66% |
| Проверок всего | 582 |
| Успешных проверок | 580 |
| Ошибок 5xx | 0 |
| Среднее время ответа | 0.704s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 99.66% | 291 | 0.954s |
| /api/tc-market/state | 99.66% | 291 | 0.453s |
