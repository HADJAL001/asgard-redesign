...
Обновлено: 2026-09-21 10:18 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 95.74% |
| Проверок всего | 94 |
| Успешных проверок | 90 |
| Ошибок 5xx | 0 |
| Среднее время ответа | 0.827s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 95.74% | 47 | 1.124s |
| /api/tc-market/state | 95.74% | 47 | 0.530s |
