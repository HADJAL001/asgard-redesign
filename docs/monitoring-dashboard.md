...
Обновлено: 2026-07-25 07:10 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 96.00% |
| Проверок всего | 50 |
| Успешных проверок | 48 |
| Ошибок 5xx | 0 |
| Среднее время ответа | 1.139s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 96.00% | 25 | 1.339s |
| /api/tc-market/state | 96.00% | 25 | 0.938s |
