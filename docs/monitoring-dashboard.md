...
Обновлено: 2026-09-26 09:38 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 97.73% |
| Проверок всего | 88 |
| Успешных проверок | 86 |
| Ошибок 5xx | 2 |
| Среднее время ответа | 0.718s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 97.73% | 44 | 0.800s |
| /api/tc-market/state | 97.73% | 44 | 0.636s |
