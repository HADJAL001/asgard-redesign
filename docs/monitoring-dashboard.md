...
Обновлено: 2026-08-26 05:24 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 99.65% |
| Проверок всего | 572 |
| Успешных проверок | 570 |
| Ошибок 5xx | 0 |
| Среднее время ответа | 0.720s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 99.65% | 286 | 0.982s |
| /api/tc-market/state | 99.65% | 286 | 0.458s |
