...
Обновлено: 2026-09-23 09:38 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 95.65% |
| Проверок всего | 92 |
| Успешных проверок | 88 |
| Ошибок 5xx | 0 |
| Среднее время ответа | 0.815s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 95.65% | 46 | 1.047s |
| /api/tc-market/state | 95.65% | 46 | 0.584s |
