...
Обновлено: 2026-08-30 10:11 UTC

## Сводка за последние 7 дней

| Метрика | Значение |
|---|---|
| Uptime (общий, health + tc-market/state) | 99.28% |
| Проверок всего | 278 |
| Успешных проверок | 276 |
| Ошибок 5xx | 0 |
| Среднее время ответа | 0.825s |

## По эндпоинтам

| Эндпоинт | Uptime | Проверок | Среднее время ответа |
|---|---|---|---|
| /api/health | 99.28% | 139 | 1.110s |
| /api/tc-market/state | 99.28% | 139 | 0.540s |
