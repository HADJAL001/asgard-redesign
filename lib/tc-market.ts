/* ================================================================
   ...
   ----------------------------------------------------------------
   ШАГ 5 (ФИНАЛЬНЫЙ): все моковые генераторы данных удалены отсюда
   (seedPriceHistory, seedTrades, buildOrderBook, priceAfterTrade).
   Реальные данные рынка TimeCoin теперь приходят с бэкенда через
   lib/store/osgard-store.tsx (useOsgardStore → fetchTcState,
   fetchOrderBook, fetchTrades и т.д.).

   Этот файл оставлен как источник:
