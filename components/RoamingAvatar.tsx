...
/* ================================================================
   OSGARD · RoamingAvatar — бродячий аватар ВАЛЛИ с push-to-talk
   ----------------------------------------------------------------
...
export function RoamingAvatar() {
  ...
  return (
    ...
    >
      <div
        role="button"
        aria-label="Удерживайте, чтобы поговорить с ВАЛЛИ"
        title={sttSupported ? "Удерживайте, чтобы поговорить с ВАЛЛИ" : "Голосовой ввод не поддерживается этим браузером"}
