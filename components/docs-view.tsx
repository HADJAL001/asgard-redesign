  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Откройте раздел «Оркестратор» и нажмите «Создать цепочку». Перетащите нужные узлы из палитры на холст: Claude, DeepSeek, Grok или Шаблон промпта. Каждому узлу можно задать системный промпт, температуру и лимит токенов.',
      },
      {
      ...
      },
      {
        ...
        body: "Запуск цепочки списывает TimeCoin — стоимость зависит от моделей, задействованных в цепочке (Claude, DeepSeek, Grok имеют разную цену за вызов, узел «Шаблон промпта» бесплатен). Если баланса не хватает, редактор покажет предложение пополнить кошелёк.",
      },
    ],
  },
  {
