...
const FAQS: Faq[] = [
  ...
  },
  {
    id: 2,
    q: "Где найти баланс?",
    a: "В «Кошельке» отображаются Credits для активности и генераций и TimeCoin для рыночных действий. Шарды и кристаллы — материалы Кузницы: они покупаются за Credits и расходуются только в рецептах.",
  },
  {
    id: 3,
