...
const FAQS: Faq[] = [
  ...
  },
  {
    id: 2,
    q: "Где найти баланс?",
    a: "В «Кошельке» отображаются Credits для активности и TimeCoin для AI-генераций и рыночных действий. Шарды и кристаллы — материалы Кузницы: они покупаются за Credits и расходуются только в рецептах.",
  },
  {
    id: 3,
