...
const ARTICLES: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Откройте созданный проект и привяжите нейросеть. Настройте параметры генерации, лимиты токенов и режим работы. Все изменения сохраняются автоматически.",
      },
      {
  ...
  },
  {
    ...
    views: 9,
    updated: "11.07.2026",
    toc: ["Обзор", "Подключение модели", "Параметры генерации", "Лимиты токенов"],
    sections: [
      ...
      { heading: "Лимиты токенов", body: "Следите за расходом токенов в разделе «Портфель». Установите лимиты, чтобы избежать перерасхода." },
    ],
  },
  {
    id: "create-artifact",
    ...
    sections: [
      ...
      { heading: "Выбор типа", body: "В Мастерской выберите тип артефакта: нейросеть, кристалл, оружие, щит или артефакт." },
  ...
  },
  {
    ...
    description: "Как отслеживать и распределять токены между проектами.",
    views: 6,
    updated: "08.07.2026",
    toc: ["Баланс токенов", "Распределение", "Лимиты"],
    sections: [
      { heading: "Баланс токенов", body: "Общий баланс отображается в разделе «Портфель». Токены расходуются на генерацию." },
