  ...
  return (
    <div className="eg-page min-h-screen font-sans" style={{ color: COLORS.text }}>
      ...
      <SectionHelp
        ...
        goals={[
          { goal: "Создать первый артефакт", steps: ["Введите название", "Выберите тип", "Проверьте Credits и материалы рецепта", "Нажмите «Создать»"] },
          { goal: "Подготовить рецепт", steps: ["Купите недостающие шарды или кристаллы за Credits", "Материалы расходуются только в Кузнице", "TimeCoin используется для рыночных действий"] },
