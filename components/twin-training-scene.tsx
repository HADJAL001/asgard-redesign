...
function Companion({ level, active, reducedMotion }: { level: number; active: boolean; reducedMotion: boolean }) {
...
export function TwinTrainingScene({ level, training }: { level: number; training: boolean }) {
  ...
  return <div className="h-48 overflow-hidden rounded-lg" aria-hidden="true" style={{ border: "1px solid #30424b" }}><Scene level={level} active={training && !reducedMotion} reducedMotion={reducedMotion} /></div>
}
