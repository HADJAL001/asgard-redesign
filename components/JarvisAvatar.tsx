...
/* ================================================================
   ...
   - accessory → доп. 3D-меши поверх аватара (плащ, корона, кольцо
                 арк-реактора, наручный проектор, частицы данных)
...
/** Кольцо арк-реактора — светящееся тонкое кольцо вокруг ядра (Iron Man style). */
