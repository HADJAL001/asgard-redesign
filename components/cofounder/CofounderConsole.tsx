...
type DiagnosticsState = { run: { status: "passed" | "needs-review" | "blocked"; findingCount: number }; findings: ErrorFinding[]; policy: { maxRepairAttempts: number } }
