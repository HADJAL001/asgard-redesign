...
type DiagnosticsState = { run: { status: "passed" | "needs-review" | "blocked"; findingCount: number; sandbox: { status: "not-run" | "unverified" | "passed" | "failed" | "timeout" | "unavailable"; exitCode: number | null; timedOut: boolean; durationMs: number; verified: boolean } }; findings: ErrorFinding[]; policy: { maxRepairAttempts: number } }
