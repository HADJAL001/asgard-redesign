...
const AGENT_GREETINGS = [
  { agent: "COFOUNDER", text: "Готов собрать первую версию за пару минут — просто опишите идею." },
  { agent: "REPLAY", text: "Если понадобится живой пример — откройте Mission Replay и разберите путь сборки." },
