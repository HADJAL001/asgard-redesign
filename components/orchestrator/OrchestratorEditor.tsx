...
.orch-ghost-node::before { content:""; position:absolute; inset:0; z-index:-1; background:linear-gradient(135deg,#1d1b16,#0f0f0d); }
...
.orch-ghost-node--architect { width:140px; height:140px; color:#d7ae57; clip-path:polygon(30% 0,70% 0,100% 30%,100% 70%,70% 100%,30% 100%,0 70%,0 30%); filter:drop-shadow(0 0 16px rgb(215 174 87 / .35)); }.orch-ghost-node--architect::before { background:linear-gradient(135deg,#29261d,#171716); clip-path:inherit; box-shadow:inset 0 0 0 2px #d7ae57; }
.orch-ghost-node--processor { width:100px; height:100px; color:#b5a681; border-radius:50%; background:linear-gradient(135deg,#29261d,#1a1a18); box-shadow:inset 0 0 0 2px #b5a681,0 0 17px rgb(181 166 129 / .25); }.orch-ghost-node--processor::before { display:none; }
