    ...
    return (
      <div className="min-h-screen font-sans" style={{ background: "linear-gradient(180deg, #10181d 0%, #0A1628 100%)", color: "#FFFFFF" }}>
        ...
        <main className="mx-auto flex max-w-[1240px] items-center justify-center px-6 py-24">
          <Loader2 size={24} className="animate-spin" style={{ color: "#9eb2bc" }} aria-hidden="true" />
        </main>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: "linear-gradient(180deg, #10181d 0%, #0A1628 100%)", color: "#FFFFFF" }}>
      ...
      <main className="mx-auto max-w-[1240px] px-6 py-10 md:px-10 md:py-12">
        ...
        {/* Artifacts */}
        <section className="mt-10 rounded-2xl p-6 md:p-8" style={{ backgroundColor: "#17242a", border: "1px solid #30424b" }}>
