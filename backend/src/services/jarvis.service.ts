...
/* ================================================================
   ...
   3. DeepSeek             — основной AI-провайдер для ответов ДЖАРВИСА
...
export type JarvisAnswer = {
  ...
  icon: string
  label: string
  /** Если ДЖАРВИС рекомендует запустить конкретную цепочку — фронт может сразу перейти на /orchestrator/:chainId?run=1 */
...
/* ================================================================
   Личность ДЖАРВИСА — хранение выбранного режима в БД (jarvis_personality)
   ================================================================ */
