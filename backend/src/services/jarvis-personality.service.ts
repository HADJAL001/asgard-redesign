/* ================================================================
   ВАЛЛИ · Personality Service (ФАЗА 1)
   ----------------------------------------------------------------
   Личность ВАЛЛИ: режимы поведения + индикатор в чате.
...
const QUOTES: string[] = [
  ...
  "«Твой близнец — это ты, но без лени.» — ВАЛЛИ",
...
/**
 * Генерирует ответ ВАЛЛИ с учётом текущего режима личности.
