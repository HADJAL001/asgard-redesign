...
export const CONNECTORS: ConnectorDefinition[] = [
  {
    ...
    name: "Cloudflare",
    category: "domains",
    description: "DNS, zones, custom domains and edge configuration for production launches.",
    icon: "globe",
  ...
  },
  {
    ...
    description: "Provision Supabase projects, inspect environments, and attach generated schemas.",
    icon: "database",
  ...
  },
  {
    ...
    name: "Hostinger",
    category: "servers",
    description: "Manage Hostinger account resources and deployment targets from one launch flow.",
    icon: "server",
    baseUrl: "https://api.hostinger.com",
    authType: "bearer",
    fields: [{ ...API_KEY_FIELD, label: "Hostinger API token" }],
    actions: [
      { id: "account", label: "Verify account", method: "GET", path: "/api/v1/accounts", isTestAction: true },
      { id: "list_vps", label: "List VPS instances", method: "GET", path: "/api/v1/vps" },
    ],
  },
  {
    id: "contabo",
    name: "Contabo",
    category: "servers",
    description: "Inspect Contabo infrastructure targets for generated application deployments.",
    icon: "server-cog",
    baseUrl: "https://api.contabo.com",
    authType: "bearer",
    fields: [{ ...API_KEY_FIELD, label: "OAuth access token" }],
    actions: [
      { id: "regions", label: "Verify access", method: "GET", path: "/v1/regions", isTestAction: true },
      { id: "list_instances", label: "List instances", method: "GET", path: "/v1/compute/instances" },
    ],
  },
  {
    id: "stripe",
