...
const ALLOWED_EVENTS = new Set([
  ...
  "blueprint_command_example_selected",
  "blueprint_command_applied",
  "blueprint_command_dry_run",
  "blueprint_delivery_policy_saved",
  "blueprint_delivery_verified",
  "blueprint_voice_command_captured",
  "blueprint_voice_command_error",
  "blueprint_voice_command_started",
  "blueprint_voice_command_unavailable",
  "delivery_preflight_viewed",
  "dashboard_cofounder_cta",
  "web_vital",
])
